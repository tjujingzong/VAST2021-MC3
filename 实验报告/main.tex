...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{images/3-1.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{images/3-3.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{images/3-4.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{images/3-5.png}
